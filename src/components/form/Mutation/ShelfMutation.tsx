...
const ItemsSection = ({ isEditing, itemsRef, defaultVals, taleons, uid }: Omit<Props, "isEditing"> & { itemsRef: React.RefObject<ListSelectorRef<TaleonSchemaType>>, uid: string; isEditing: boolean }) => {
