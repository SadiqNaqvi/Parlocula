...
const preCheck = async ({ data, user_id }: any) => {
  // Checking if the author of the post or the author of the replied comment has blocked current user or not.
