            ...
            {page === 1 ?
                (
                    <Form className="space-y-4" defaultVals={{ email }} submit={submitEmailAndSendCode} schema={emailUpdateSchema}>
                        ...
                        {canUpdate ?
                            <p>Email can be updated only once in a month. Your email help us identify you and help us keep you inform with importannt information through email. Make sure nnot to change your email unless it is necessary.</p>
                            :
