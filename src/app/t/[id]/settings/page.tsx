    ...
    return (
        <>
            ...
            <Sections heading="Appearance">
                <ListContainer href={`/t/${id}/settings/edit`}>
                    <EditIcon />
                    <span>Edit Thread</span>
                </ListContainer>
            </Sections>
            <Sections heading="People">
                <ListContainer href={`/t/${id}/members`}>
                    <GroupIcon />
                    <span>Members</span>
                </ListContainer>
                <ListContainer href={`/t/${id}/settings/managers`}>
                    <ShieldIcon />
                    <span>Managers</span>
                </ListContainer>
                <ListContainer href={`/t/${id}/settings/banned`}>
                    <BlockOrBanIcon />
                    <span>Banned</span>
                </ListContainer>
            </Sections>
            <Sections heading="Activity">
                <ListContainer href={`/t/${id}/settings/reports`}>
                    <AlertIcon />
                    <span>Reports on Thread</span>
                </ListContainer>
                <ListContainer href={`/t/${id}/settings/reports/posts`}>
                    <PostIcon />
                    <span>Reported Posts</span>
                </ListContainer>
                <ListContainer href={`/t/${id}/settings/reports/comments`}>
                    <CommentIcon />
