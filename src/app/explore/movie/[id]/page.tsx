import { RefinedCast, RefinedCrew } from "@lib/types"
import { StarIcon, CrownIcon, HeartIcon, CollectionIcon, ThreadIcon, LinkIcon } from "@assets/Icons"
import { ContentBox, MainPageHeader, DataFetcher, TrailerComponent, RatingComponent } from "@components";
import { Metadata } from "next";
import { fetchMovie, fetchMoviesWithCast, fetchMoviesWithGenres } from "@lib/contentFetcher";
...
export default async function MoviePage({ params, searchParams }: props) {
    ...
    if (!content) return <>Oops! Something Went Wrong! Please Try Again.</>
    // const content: RefinedMovieData = movieDataShaper(tmdb_content, cast, crew, exampleTrailerData.results, omdb_content);
    ...
    return (
        <main>
            ...
            <div className="mt-8 pt-8 border-t border-[var(--gray30)] grid gap-6 grid-cols-1 lg:grid-cols-[2.5fr,1fr] p-2 lg:p-6">
